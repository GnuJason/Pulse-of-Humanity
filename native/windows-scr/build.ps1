...
$assetSource = Join-Path $projectDir "assets\screensaver"
...
if (-not (Test-Path $assetSource)) {
  throw "Bundled screensaver assets were not found at $assetSource. Run npm run build:native:assets first."
}
